          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(onTap: ()=>Get.to(const Signup()),child: Text('Register Now',style:TextStyle(fontWeight: FontWeight.bold,color: Theme.of(context).colorScheme.primary),))
              ],
            ),
            const SizedBox(height: 20,),
            GestureDetector(onTap: ()=>Get.to(const Forgot()),child: Text('Forgot Password?',style:TextStyle(fontWeight: FontWeight.bold,color: Theme.of(context).colorScheme.primary),)),
            const Text('--------------------------------or-------------------------------------'),

            ElevatedButton(onPressed: (()=>login()), child: const Padding(
